...
{
    public class LocalSourcesModel
    {
        ...
        public LocalSourcesModel(ILocalVideoSourceManager localVideoSourceManager, ILocalAudioSourceManager localAudioSourceManager, 
            CoreData coreData, 
